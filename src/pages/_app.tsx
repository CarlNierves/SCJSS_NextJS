...
// Custom hooks
import { StoreProvider } from 'src/hooks/useCart';
...
const client = new ApolloClient({ cache: new InMemoryCache(), uri: "https://cm.scnextjs.localhost/sitecore/api/graph/edge",});
