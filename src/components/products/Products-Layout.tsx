...
const ProductsLayout = ({ rendering }: ComponentProps): JSX.Element => {
  ...
  return (
    <div data-e2e-id="Products-Layout">
      {disconnectedMode && (
        <>
          <p>
      ...
      {!disconnectedMode && <Placeholder name="jss-products-layout" rendering={rendering} />}
    </div>
  );
};
