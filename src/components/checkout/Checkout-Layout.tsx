...
const CheckoutLayout = ({ rendering }: ComponentProps): JSX.Element => {
  ...
  return (
    <div className='container mt-4' data-e2e-id="Checkout-Layout">
      <div className="row">
        <div className="col-8 mt-5">
          ...
          {!disconnectedMode && <Placeholder name="jss-checkout-list-layout" rendering={rendering} />}
        </div>
        <div className="col-4 mt-5">
          ...
          {!disconnectedMode && <Placeholder name="jss-checkout-summary-layout" rendering={rendering} />}
        </div>
        <div className="col-8 mt-5">
          {disconnectedMode && (
              <>
          ...
          {!disconnectedMode && <Placeholder name="jss-checkout-form-layout" rendering={rendering} />}
        </div>
      </div>
    </div>
  );
